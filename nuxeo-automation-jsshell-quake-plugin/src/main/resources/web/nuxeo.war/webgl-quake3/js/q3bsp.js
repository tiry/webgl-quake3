...
q3bsp = function(gl) {
    ...
    this.worker = new Worker('/nuxeo/webgl-quake3/js/q3bsp_worker.js');
...
q3bsp.prototype.load = function(url, tesselationLevel) {
    ...
    this.worker.postMessage({
        ...
        url: '/nuxeo/webgl-quake3/' + q3bsp_base_folder + '/' + url,
...
q3bsp.prototype.loadShaders = function(sources) {
    ...
    for(var i = 0; i < sources.length; ++i) {
        sources[i] = "webgl-quake3/" + q3bsp_base_folder + '/' + sources[i];
    }
